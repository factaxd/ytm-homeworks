...
class Ders(ABC):
    ...
    def __str__(self):
        secmeli_str = "Evet" if self.secmeli else "Hayır"
        return f"Ders: {self.ders_adi}, Kod: {self.ders_kodu}, Dönem: {self.donem}, Seçmeli: {secmeli_str}, Sorumlu: {self.ders_sorumlusu}, Kredi: {self.kredi}"
